...
---
## Purpose
Enable members to build long‑term ownership in the co‑op by contributing “sweat equity” (the discount between standard market rates and the Co‑op Rate) on film/TV projects, while preserving cash for production.
## Background & Rationale

___
## Rates
### Rate Card Publication
Publish an annual SCR table by role/experience level (e.g., Producer, Line Producer, DP, Gaffer, Editor, Colorist, Composer).
Calibrate from recent market quotes, union minimums (if applicable), and regional benchmarks.
Update annually or per half‑year; changes apply prospectively.
### Co‑op Rate Setting
...
- The co-op must retain ownership, profit participation, or producer fee rights that entitle it to a share of future revenues.
- Projects must have a clear revenue waterfall or recoupment structure that includes the co-op as a beneficiary.
#### Commercial Viability Assessment
Each project must undergo a commercial viability review by the co-op’s board or designated committee, assessing:
- Market potential
...
Projects must meet minimum production budget levels that support professional execution and market competitiveness:

- Short films: ≥ $25,000
- Feature films: ≥ $150,000
- TV/web series episodes: ≥ $50,000 per episode
(Lower-budget projects may be considered if they have confirmed distribution or revenue guarantees.)
#### Co-op Affiliation & Control
The project must be produced by, or in partnership with, the co-op or a co-op-controlled entity (e.g., SPV), ensuring alignment with co-op values and financial participation.
#### Member Participation
The project must offer meaningful roles to co-op members across key creative and technical departments, with a minimum threshold of 50% crew composition from the co-op membership.
#### Board Approval
Final eligibility is subject to Board or Steering Committee approval, based on the above criteria and alignment with the co-op’s strategic goals.
___
## Share Valuation & Pricing
### Share Price (SP) Windows
Establish quarterly or semi‑annual pricing windows (e.g., Jan–Jun, Jul–Dec).
During each window, all conversions use the same SP.

### How to Set SP (pick one, document it, and stick to it for the window)
Net Asset Value (NAV) Method: (Total assets – liabilities) ÷ fully diluted shares. Appropriate for early‑stage co‑ops.
Earnings/Revenue Multiple: For mature co‑ops with steady cashflows (e.g., EBITDA multiple normalized to co‑op sector).
Hybrid: NAV + weighted factor for pipeline (discounted probability of conversion).
...
___
## Accounting & Invoicing Flow
6.1 Invoicing

Member invoices only the Co‑op Rate (CR) in cash.
A separate Sweat Equity Statement accompanies each invoice or month‑end close showing DA.

6.2 Ledger Entries (illustrative; confirm with your accountant)

Record CR as normal wage/contract expense (cash out).
Record DA to an equity reserve (e.g., “Contributed Services—Members”), offsetting an equity liability (to be settled in shares).
On conversion date: move from liability to common equity at SP; record share issuance.

6.3 Tax treatment

Varies by jurisdiction. Often, services-for-equity create a taxable event at fair market value of shares issued; you may need 83(b)-style elections where applicable. Get professional advice and document policies (§9).


7) Project‑Level Rules
7.1 Project Approval

Projects eligible for the program must be approved by the co‑op board/steering committee with:

Budget & cashflow
Proposed Co‑op Rate bands by department
Target conversion window (SP period)
Any union/collective agreement confirmations



7.2 Recoupment & Waterfall (if using SPV/LLC)

If you run productions through a project SPV:

The co‑op invoices the SPV at CR.
Members accrue DA with the co‑op, not the SPV.
Project revenues flow: Distributor → SPV → (recoup debt/cash investors first) → co‑op producer fees/overages.


Keep the equity program at the co‑op level for simplicity; reserve separate profit participations for project investors.


8) Governance & Bylaws Alignment
...
9) Legal & Compliance Checklist (summarized)
...
(This is not legal or tax advice—engage local counsel/CPA.)

10) Risk Controls & Practical Rules
...
DP works 12 shoot days.
SCR = $1,200/day; CR = $900/day → DA/day = $300.
Total DA = 12 × $300 = $3,600.
Quarter’s SP = $6.00/share.
Shares issued = $3,600 ÷ $6.00 = 600 shares.

Accounting:

Cash expense: 12 × $900 = $10,800.
Equity reserve (liability) accrues: $3,600.
On issuance: debit reserve $3,600; credit common equity (600 shares @ $6 FMV).