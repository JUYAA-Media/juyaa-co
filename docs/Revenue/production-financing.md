...
: The Collective is assigned rights to incoming funds (e.g., grant drawdowns, distributor payments).
Completion Bond or Insurance
: Required for larger productions.
Caps
: Max financing per project (e.g., $100k–$500k); max exposure per year.
Reserves
...
2. **Payroll Processing**
    - The Collective either disburses funds directly or provides direct [payroll services](<./services.md>) to production.
