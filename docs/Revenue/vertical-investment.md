...
1× non‑participating preference; 6–8% dividend (pay‑if‑able); standard minority protections.
### Revenue‑Share Notes
3–6% top‑line rev share until 1.5–2.0× cap; helpful for rental/post with stable bookings.
### Equipment SPVs (Sale‑Leaseback)
Co‑op SPV buys gear; portfolio company leases; co‑op earns lease yield + residual value.
### Convertible Notes (Tech)
Discount + cap; converts on institutional round; early influence via advisory agreements.
### Project‑Linked Sidecars
For distribution/marketing firms, sidecars co‑fund P&A or minimum guarantees with recoupment priority.
___
## Risk Management

Cycle Risk: diversify by vertical and client mix; avoid over‑exposure to single streamer/broadcaster.
Key‑Person Risk: require key‑person insurance and vesting/retention packages.
Currency & Jurisdiction: hedge large FX exposures; standardize contracts; use local counsel.
Technology Obsolescence: rolling capex plans; vendor buy‑back agreements; secondary markets.
Labor/Union Dynamics: maintain compliance; budget for negotiated increases; contingency plans.
Counterparty Risk: strict receivables management; lockbox arrangements for distributors where possible.
___
## Portfolio KPIs & Impact Metrics
### Financial/Operational
EBITDA margin, FCF conversion, utilization rates (stages, suites, gear), on‑time delivery %, rework %, average day rate, AR days.
### Strategic/Commercial
Cross‑sell penetration across portfolio, share of co‑op projects serviced, PSA savings captured.
### Workforce/Impact
Jobs created, apprentice hours, certifications earned, local vendor spend %, workforce diversity, CO₂ per production day.
### Governance/Reporting
Quarterly KPI pack; annual audited financials; capex plan vs. outcomes; risk register.
___
## Exit & Liquidity Pathways (for a Co‑op)

Issuer Buyback at pre‑agreed valuation methods (e.g., EBITDA multiple bands).
...
### Phase 1: Set‑Up (Months 0–3)
Approve investment policy, reserved matters model, PSA template, impact policy.
Stand up an Investment Committee (IC) and Portfolio Operations (PortOps) function.
Build deal pipeline map across target verticals and geographies.
### Phase 2: Beachhead Investments (Months 3–9)
3–5 transactions across rental, post, distribution/marketing, and payroll/insurance.
Execute PSAs to channel co‑op demand; deploy initial shared services (procurement, reporting).
### Phase 3: Infrastructure Anchors (Months 9–18)
One soundstage/backlot or virtual production anchor (often syndicated).
Launch Academy with portfolio companies; begin apprenticeship cohorts.
### Phase 4: Optimization & Scale (Months 18–24)
Standardize KPIs dashboards; quarterly portfolio reviews.
Expand cross‑sell bundles; add a localization or royalty accounting tech asset.
Evaluate first partial liquidity (secondary or dividend recap) if performance supports.