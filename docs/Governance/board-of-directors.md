...
- Directors serve a maximum term of two (2) years, except for the initial board, which may have varied terms to enable staggered elections.
- Board seats shall be staggered so that at least two (2) seats are up for election at each Annual General Meeting (AGM)
...
- At the start of every calendar year, the Co-operative shall create a **Nomination Pool** for Board and subcommittee nominations/appointments.
- Eligibility Criteria:
    - Must be a member for over two (2) years.
    - Must be a member in good standing (no outstanding dues or disciplinary issues).
    - Must pass a fit and proper assessment as defined by applicable regulations.
- The pool is opt-in/opt-out:
    - Members may accept inclusion.
    - Temporarily withdraw for the current year.
    - Permanently withdraw from future consideration.
- The Secretary shall maintain records of acceptance and withdrawal status.

---
### 6. Notification and Acceptance
- Eligible members are notified annually and given **14 days** to respond.
- Non-response defaults to **temporary decline** for that year.
---
### 7. Election Process
- Elections for Board seats occur at the AGM in accordance with bylaws.
...
- The Secretary shall maintain:
    - Current Board roster and term expiration dates.
    - Nomination Pool list and acceptance/decline records.
    - Election results and officer appointments.
___
## Compensation
...
- Amendments require Board approval and, where applicable, ratification by the general membership.